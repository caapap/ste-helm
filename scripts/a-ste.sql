...
drop database if exists ste_v2;
create database ste_v2;
use ste_v2;
...
CREATE TABLE `alert_rule` (
    ...
    `append_tags` varchar(255) not null default '' comment 'split by space: service=ste mod=api',
...
--     `data` text not null,
--     `append_tags` varchar(255) not null default '' comment 'split by space: e.g. mod=ste dept=cloud',
--     `create_at` bigint not null default 0,
--     `create_by` varchar(64) not null default '',
--     `update_at` bigint not null default 0,
--     `update_by` varchar(64) not null default '',
...
CREATE TABLE `recording_rule` (
    ...
    `prom_eval_interval` int not null comment 'evaluate interval',
    `append_tags` varchar(255) default '' comment 'split by space: service=ste mod=api',
...
(
    ...
    `datasource_id` bigint not null default 0 comment 'datasource id',
    `engine_cluster` varchar(128) not null default '' comment 'ste-alert cluster',
